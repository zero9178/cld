...
CATCH_REGISTER_ENUM(
    OpenCL::Lexer::TokenType, OpenCL::Lexer::TokenType::Identifier, OpenCL::Lexer::TokenType::OpenBracket,
    OpenCL::Lexer::TokenType::CloseBracket, OpenCL::Lexer::TokenType::OpenBrace, OpenCL::Lexer::TokenType::CloseBrace,
    OpenCL::Lexer::TokenType::Literal, OpenCL::Lexer::TokenType::StringLiteral, OpenCL::Lexer::TokenType::SemiColon,
...
TEST_CASE("Lexing positions", "[lexer]")
{
    ...
    SECTION("Random tokens")
    {
        ...
        std::array correct = {std::tuple{TokenType::OpenBracket, 1, 0, 1},
                              std::tuple{TokenType::CloseBracket, 1, 1, 1},
        ...
        auto result = OpenCL::Lexer::tokenize(R"(void updateHeight(TreeNode* h)
{
    ...
    5 + 7 - .53f + "dwawd""test"id
        ...
        std::array correct = {
            ...
            std::tuple{TokenType::OpenBracket, 1, 17, 1},    std::tuple{TokenType::Identifier, 1, 18, 8},
            std::tuple{TokenType::Asterisk, 1, 26, 1},       std::tuple{TokenType::Identifier, 1, 28, 1},
            std::tuple{TokenType::CloseBracket, 1, 29, 1},   std::tuple{TokenType::OpenBrace, 2, 0, 1},
            std::tuple{TokenType::IfKeyword, 3, 4, 2},       std::tuple{TokenType::OpenBracket, 3, 7, 1},
            std::tuple{TokenType::Identifier, 3, 8, 6},      std::tuple{TokenType::OpenBracket, 3, 14, 1},
            std::tuple{TokenType::Identifier, 3, 15, 1},     std::tuple{TokenType::Arrow, 3, 16, 2},
            std::tuple{TokenType::Identifier, 3, 18, 5},     std::tuple{TokenType::CloseBracket, 3, 23, 1},
            std::tuple{TokenType::GreaterThan, 3, 25, 1},    std::tuple{TokenType::Identifier, 3, 27, 6},
            std::tuple{TokenType::OpenBracket, 3, 33, 1},    std::tuple{TokenType::Identifier, 3, 34, 1},
            std::tuple{TokenType::Arrow, 3, 35, 2},          std::tuple{TokenType::Identifier, 3, 37, 4},
            std::tuple{TokenType::CloseBracket, 3, 41, 1},   std::tuple{TokenType::CloseBracket, 3, 42, 1},
            ...
            std::tuple{TokenType::OpenBracket, 5, 26, 1},    std::tuple{TokenType::Identifier, 5, 27, 1},
            std::tuple{TokenType::Arrow, 5, 28, 2},          std::tuple{TokenType::Identifier, 5, 30, 5},
            std::tuple{TokenType::CloseBracket, 5, 35, 1},   std::tuple{TokenType::SemiColon, 5, 36, 1},
            ...
            std::tuple{TokenType::OpenBracket, 9, 26, 1},    std::tuple{TokenType::Identifier, 9, 27, 1},
            std::tuple{TokenType::Arrow, 9, 28, 2},          std::tuple{TokenType::Identifier, 9, 30, 4},
            std::tuple{TokenType::CloseBracket, 9, 34, 1},   std::tuple{TokenType::SemiColon, 9, 35, 1},
