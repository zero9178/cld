...
cld::CGLLVM::Value cld::CGLLVM::CodeGenerator::x64LoadFromStack(Value vaList, llvm::Type* destType)
{
    ...
    auto incremented = createGEP(
        loadedStackPointer,
        m_builder.getInt64(cld::roundUpTo(m_module.getDataLayout().getTypeAllocSize(destType).getKnownMinSize(), 8)));
