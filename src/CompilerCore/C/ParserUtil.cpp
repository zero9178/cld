...
bool OpenCL::Parser::firstIsInFunctionDefinition(const Lexer::Token& token,
                                                 const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInDeclarationSpecifier(token, context);
}

bool OpenCL::Parser::firstIsInDeclaration(const Lexer::Token& token, const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInDeclarationSpecifier(token, context);
}

bool OpenCL::Parser::firstIsInDeclarationSpecifier(const Lexer::Token& token,
                                                   const OpenCL::Parser::ParsingContext& context)
{
...
bool OpenCL::Parser::firstIsInSpecifierQualifier(const Lexer::Token& token,
                                                 const OpenCL::Parser::ParsingContext& context)
{
    switch (token.getTokenType())
    {
...
bool OpenCL::Parser::firstIsInDeclarator(const Lexer::Token& token, const OpenCL::Parser::ParsingContext& context)
{
...
bool OpenCL::Parser::firstIsInAbstractDeclarator(const Lexer::Token& token,
                                                 const OpenCL::Parser::ParsingContext& context)
{
...
bool OpenCL::Parser::firstIsInPointer(const Lexer::Token& token, const OpenCL::Parser::ParsingContext&)
{
...
bool OpenCL::Parser::firstIsInInitializer(const Lexer::Token& token, const OpenCL::Parser::ParsingContext& context)
{
...
bool OpenCL::Parser::firstIsInAssignmentExpression(const Lexer::Token& token,
                                                   const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInUnaryExpression(token, context) || firstIsInConditionalExpression(token, context);
}

bool OpenCL::Parser::firstIsInConditionalExpression(const Lexer::Token& token,
                                                    const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInLogicalOrExpression(token, context);
}

bool OpenCL::Parser::firstIsInLogicalOrExpression(const Lexer::Token& token,
                                                  const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInLogicalAndExpression(token, context);
}

bool OpenCL::Parser::firstIsInLogicalAndExpression(const Lexer::Token& token,
                                                   const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInBitOrExpression(token, context);
}

bool OpenCL::Parser::firstIsInBitOrExpression(const Lexer::Token& token, const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInBitXorExpression(token, context);
}

bool OpenCL::Parser::firstIsInBitXorExpression(const Lexer::Token& token, const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInBitAndExpression(token, context);
}

bool OpenCL::Parser::firstIsInBitAndExpression(const Lexer::Token& token, const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInEqualityExpression(token, context);
}

bool OpenCL::Parser::firstIsInEqualityExpression(const Lexer::Token& token,
                                                 const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInRelationalExpression(token, context);
}

bool OpenCL::Parser::firstIsInRelationalExpression(const Lexer::Token& token,
                                                   const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInShiftExpression(token, context);
}

bool OpenCL::Parser::firstIsInShiftExpression(const Lexer::Token& token, const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInAdditiveExpression(token, context);
}

bool OpenCL::Parser::firstIsInAdditiveExpression(const Lexer::Token& token,
                                                 const OpenCL::Parser::ParsingContext& context)
{
    return firstIsInTerm(token, context);
}

bool OpenCL::Parser::firstIsInTerm(const Lexer::Token& token, const OpenCL::Parser::ParsingContext& context)
{
...
bool OpenCL::Parser::firstIsInCastExpression(const Lexer::Token& token, const OpenCL::Parser::ParsingContext& context)
{
