...
OpenCL::Semantics::ConstantEvaluator::ConstantEvaluator(const std::function<const RecordType*(const std::string&)>& recordCallback,
                                                        const std::function<const Type*(const std::string&)>& typedefCallback,
                                                        const std::function<void(const Message&)>& loggerCallback)
    : m_recordCallback(recordCallback), m_typedefCallback(typedefCallback), m_loggerCallback(loggerCallback)
{}
