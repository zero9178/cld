...
#if (__cplusplus == 201103L || defined(TL_FUNCTION_REF_MSVC2015) || defined(TL_FUNCTION_REF_GCC49)) \
...
namespace tl
{
    namespace detail
    {
        namespace fnref
        {
            ...
            constexpr auto invoke(Fn&& f,
                                  Args&&... args) noexcept(noexcept(std::mem_fn(f)(std::forward<Args>(args)...)))
            ...
            struct invoke_result_impl<
                F, decltype(tl::detail::fnref::invoke(std::declval<F>(), std::declval<Us>()...), void()), Us...>
            {
    ...
    public:
        ...
        template <typename F,
                  detail::fnref::enable_if_t<!std::is_same<detail::fnref::decay_t<F>, function_ref>::value
        ...
        template <typename F,
                  detail::fnref::enable_if_t<detail::fnref::is_invocable_r<R, F&&, Args...>::value>* = nullptr>
